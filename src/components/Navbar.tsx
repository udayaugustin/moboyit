...
<div className="w-full max-w-[960px] mx-auto">
    <div className="flex justify-center gap-0">
          ...
          <div className="w-1/3 flex justify-end pt-3">
            ...
            <NavItem text="Explore" to="/explore" className="font-medium pl-2 min-[400px]:pl-6 sm:pl-0" />
          ...
          <div className="w-1/3 flex justify-start pt-3">
            ...
            <NavItem text="Express" to="/express" className="font-medium pr-2 min-[400px]:pr-6 sm:pr-0" />
            </div>
          </div>
        </div>
